...
ceo_director = ceo_director_info['name']
title = ceo_director_info['title']
...
# print(ceo_director)
# print(title)
# Total Revenue (💵): 416161005568
# Net Income (Profit 💰): 112010002432
# Revenue Growth (📈): 0.079
# Earnings Growth (📊): 0.912
# Free Cash Flow (💵): 78862254080
# Debt to Equity (⚖️): 152.411
# Return on Equity (💡): 1.714
# Profit Margin (🏦): 0.269
# PE Ratio (💵/💼): 36.24
